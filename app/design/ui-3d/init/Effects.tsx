...
const Effects = () => {
  ...
  const outlineEffect = useMemo(() => {
    ...
    // effect.uniforms.clippingPlanes.value = clippingPlanes;
    console.log()
  ...
  useOutlineEvent(({ objects, clippingPlanes }) => {
    outlineEffect.selection.set(objects)
    console.log({ clippingPlanes })
    outlineEffect.uniforms.set("clippingPlanes", new Uniform(clippingPlanes))
  })
